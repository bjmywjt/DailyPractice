...
public class HttpClient {
    ...
    public static String sendGetRequest(String reqURL, Map<String, String> parameters, String decodeCharset) {
        ...
        try {
            ...
            httpGet.addHeader("Authorization","Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJwdXp6bGUiLCJpYXQiOjE1MTc5OTk0NTUsInN1YiI6IjEiLCJleHAiOjE1MTg2MDQyNTUsIm5hbWUiOiJhZG1pbiJ9.HlJzPoLliJIp2gIZRm4fN1ycQTxYd44fNJV8NIoycew");
